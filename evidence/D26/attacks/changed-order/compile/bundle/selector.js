...
export const STRATEGY = /*STRATEGY-BEGIN*/{"strategy_id":1,"strategy_certificate_id":1000,"transfers":[{"relation":"mirror","type":"Entry","mode":"copy"},{"relation":"post","type":"Entry","mode":"copy"}],"goals":[],"dispatch_order":[0],"variants":[{"plan_id":0,"certificate_id":1,"guard":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out","entry_in","entry_out"],"requirements":[{"relation":"mirror","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]},{"relation":"post","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]}]}]}/*STRATEGY-END*/;
// sha256 of the strategy data above, as the compiler rendered it: every evidence tape of this bundle names it
export const STRATEGY_SHA256 = '542dec77108eab87ecfd49050269e314bb3c8c43d6b4cc61c8307cc010ce73af';
