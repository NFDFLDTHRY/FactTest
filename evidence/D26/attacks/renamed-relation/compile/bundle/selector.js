...
export const STRATEGY = /*STRATEGY-BEGIN*/{"strategy_id":1,"strategy_certificate_id":1000,"transfers":[{"relation":"posted","type":"Entry","mode":"copy"},{"relation":"mirror","type":"Entry","mode":"copy"}],"goals":[],"dispatch_order":[0],"variants":[{"plan_id":0,"certificate_id":1,"guard":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out","entry_in","entry_out"],"requirements":[{"relation":"posted","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]},{"relation":"mirror","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]}]}]}/*STRATEGY-END*/;
// sha256 of the strategy data above, as the compiler rendered it: every evidence tape of this bundle names it
export const STRATEGY_SHA256 = '9bccc23f57529c06f7e243b9b25132e4a50297cdfa57d2b6ee9dd574d36d6fd4';
