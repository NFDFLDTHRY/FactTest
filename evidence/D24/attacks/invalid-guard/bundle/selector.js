...
export const STRATEGY = /*STRATEGY-BEGIN*/{"strategy_id":1,"strategy_certificate_id":1000,"transfers":[{"relation":"post","type":"Entry","mode":"copy"},{"relation":"mirror","type":"Entry","mode":"copy"}],"goals":[],"dispatch_order":[0],"variants":[{"plan_id":0,"certificate_id":1,"guard":["NOBACKEND"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out","entry_in","entry_out"],"requirements":[{"relation":"post","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]},{"relation":"mirror","backends":["CPU_WASM64"],"adapters":["wasm64_relay"],"conversions":["entry_in","entry_out"]}]}]}/*STRATEGY-END*/;
